...
export async function loadAtlas(
  ...
  // Upload as-is — image row 0 (top of image) maps to UV.y = 0. Tile id
  // 0 sits at image top-left under this convention; the shader takes care
  // of orienting each cell right-side-up.
