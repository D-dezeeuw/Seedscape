...
describe("entityCenter", () => {
  test("returns world-space center (entity worldX/Y + 0.5 on both axes)", () => {
    ...
    const v = new Villager(1, { chunkX: 0, chunkY: 0, localX: 4.0, localY: 5.0 }, "T", {
      x: 0,
      y: 0,
    });
  ...
  test("respects sub-tile localX/localY", () => {
    const v = new Villager(1, { chunkX: 0, chunkY: 0, localX: 4.25, localY: 5.75 }, "T", {
      x: 0,
      y: 0,
    });
  ...
  test("respects chunk offsets (negative chunks)", () => {
    const v = new Villager(1, { chunkX: -1, chunkY: 0, localX: 31.0, localY: 0.0 }, "T", {
      x: 0,
      y: 0,
    });
