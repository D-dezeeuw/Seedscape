...
const RAW: ReadonlyArray<ItemDef> = [
  ...
  { id: ITEM_IDS.WHEAT_SEED, name: "wheat_seed", displayName: "Wheat Seeds", basePrice: 1, weight: 1 },
  { id: ITEM_IDS.CARROT_SEED, name: "carrot_seed", displayName: "Carrot Seeds", basePrice: 2, weight: 1 },
  { id: ITEM_IDS.CORN_SEED, name: "corn_seed", displayName: "Corn Seeds", basePrice: 2, weight: 1 },
  ...
  { id: ITEM_IDS.CARROT, name: "carrot", displayName: "Carrot", basePrice: 5, weight: 8 },
  { id: ITEM_IDS.CORN, name: "corn", displayName: "Corn", basePrice: 4, weight: 12 },
  // Flour is sack-heavy on purpose so the mill→bakery haul (Phase 8) feels
  // like real labour. Bread is light enough that a settler can run a stack.
  { id: ITEM_IDS.FLOUR, name: "flour", displayName: "Flour", basePrice: 12, weight: 25 },
  { id: ITEM_IDS.BREAD, name: "bread", displayName: "Bread", basePrice: 25, weight: 6 },
];
